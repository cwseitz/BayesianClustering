...
Kclust <- function(pts, sds=0, xlim, ylim, psd=NULL, minsd=NULL, maxsd=NULL, useplabel=TRUE, alpha=NULL, pb=.5, rseq=seq(1,2,by=0.025), thseq=seq(0.1,4,by=0.1), score=FALSE, rlabel=FALSE, report=TRUE){
  N = dim(pts)[1]
